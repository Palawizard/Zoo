...
{
    public static readonly IBrush Success = Brush.Parse("#1F6A4E");
    public static readonly IBrush Warning = Brush.Parse("#B86A2D");
    public static readonly IBrush Danger = Brush.Parse("#A33D3D");
    public static readonly IBrush Info = Brush.Parse("#2B7285");
    public static readonly IBrush Muted = Brush.Parse("#7B817C");
    public static readonly IBrush MessageGoodFill = Brush.Parse("#E9F3EC");
    public static readonly IBrush MessageGoodBorder = Brush.Parse("#BFD7C4");
    public static readonly IBrush MessageBadFill = Brush.Parse("#FFF0EE");
    public static readonly IBrush MessageBadBorder = Brush.Parse("#E4B8B4");
}
